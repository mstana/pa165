...
<a class="btn btn-default" href="${pageContext.request.contextPath}/rooms/${hotel.id}"><fmt:message
        key="general.back"/></a>
...
<div class="panel panel-default">
    ...
    <form action="#" method="post" role="form">
        <div class="form-group">
            ...
            <input type="text" name="number" id="numberInput" value="${room.number}" class="form-control"
                   placeholder="<fmt:message key="room.number.plc"/>"/>
        </div>

        <div class="form-group">
            <label for="priceInput"><fmt:message key="room.price"/></label>
            <input type="text" name="price" id="priceInput" value="${room.price}" class="form-control"
                   placeholder="<fmt:message key="room.price.plc"/>"/>
        </div>
